<div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            <div class="nav-profile-image">
                                <img src="layout/images/faces/IMG_20160610_193901.jpg" alt="profile">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="comment_lesson.php">
                            <span class="menu-title">تعليقات الدروس</span>
                            <i class="mdi mdi-comment menu-icon"></i>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="comment_artical.php">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link " data-toggle="collapse " href="logout.php" aria-expanded="false " aria-controls="general-pages ">
