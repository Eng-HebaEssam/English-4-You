                ...
                <div class="content-wrapper ">
                    <div class="page-header ">
                        ...
                        <div class="">
                            ...
                            <button style="color:darkblue;font-size:15px " type="button " class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#add2">أضافة درس بلنك</button>
                            <button style="color:darkblue;font-size:15px " type="button " class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#add3">أضافة بث مباشر</button>
                        </div>
                    </div>
                    <?php 
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if (isset($_POST['add3'])) {
                                ...
                                if (isset($name)) {
                                    if (strlen($name) < 4) {$formErrors[] = 'يجب وضع اسم للبث ';}
                                }
                                if (isset($video)) {
                                    if (strlen($video) < 4) {$formErrors[] = 'يجب وضع لنك البث';}
                                }
                                // Check If There's No Error Proceed The User Add
                                if (empty($formErrors)) {
                                        $stmt = $con->prepare("INSERT INTO 
                                                    lessons(orders, lesson_name, lesson_description, video, lesson_data, member_id, cat_id, youtube, Approve)
                                                    VALUES(:orders, :lesson_name, :lesson_description, :video, now(), :member_id, :cat_id, 1, 1)");
                                        $stmt->execute(array(
                                            'orders'           => $ordering,
                                            'lesson_name'           => $name,
                                            'lesson_description'    => $description,
                                    ...
                                    <div class="table-responsive ">
							            ...
							            foreach($rows as $row) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                        if($row['video_name']==''){echo'<label class="badge badge-gradient-danger">بلنك</label>';}
                    ...
                    <div class="row ">
                        <div class="col-12 grid-margin ">
                            <div class="card ">
                                <div class="card-body ">
                                    <h4 class="card-title ">البث من اليوتيوب</h4>
                                    <div class="table-responsive ">
                                        <table class="table" id="datatableid">
                                            <thead>
                                                <tr>
                            ...
                            <div class="modal-content">
                                ...
                                <form class="float-right" action="lessons.php" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group ">
                                                <h4 style="direction: ltr;"> : اظهار الدرس  بدون امتحان</h4>
                            ...
                            <div class="modal-content">
                                ...
                                <form class="float-right" action="lessons.php" method="POST">
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group ">
                                                <h4>لنك الفيديو</h4>
                                                <textarea name="link" class="form-control  text-left" style="height: 150px;" reqired dir="ltr"></textarea>
                                            </div>
                                            <div class="form-group ">
                                                <h4>ورق الشرح</h4>
                                                <textarea name="pdf" class="form-control"  style="height: 100px;"></textarea>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form class="float-right" action="lessons.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit " class="btn btn-info" name="add3">اضافة البث</button>    
                                        <button type="button " class="btn btn-secondary" data-dismiss="modal">الغاء</button>
                                    </div>
                                </form>
                            </div>
