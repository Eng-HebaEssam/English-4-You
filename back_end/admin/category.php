            ...
            <div class="main-panel ">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if (isset($_POST['add'])) {
                        ...
                        if (empty($formErrors)) {
                                ...
                                $stmt = $con->prepare("INSERT INTO 
                                    category(category_name, category_description, parent, ordering)
                    ...
                    if (isset($_POST['edit'])) {
                        ...
                        $catid         = filter_var($_POST['catid'], FILTER_SANITIZE_NUMBER_INT);
                        if (empty($formErrors)) {
                            $stmt = $con->prepare("UPDATE category SET category_name = ?,category_description = ? WHERE category_id  = ?");
                            $stmt->execute(array($name, $description, $catid ));
                            if ($stmt) {
                                echo '<div class="alert alert-success text-center alert-dismissible fade show" role="alert" id="alert-message">
                                    ...
                                    <div class="table-responsive ">
                                        <table class="table" id="datatableid">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button " class="btn btn-outline-success btn-sm edit_cat main_view" value="<?php echo $row['category_id'];?>" data-toggle="modal" data-target="#edit">تعديل</button>
                                    ...
                                    <div class="modal-body main_edit">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <select name="parent" class="form-control inputName ">
                                                ...
                                                <option disabled>قسم فرعي</option>
                                                <?php 
