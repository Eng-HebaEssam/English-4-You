                            ...
                            if (isset($_POST['add'])) { 
                                ...
                                if (empty($formErrors)) {
                                    $stmt = $con->prepare("INSERT INTO 
                                            live(orders, link, cat_id, date)
                                        VALUES(:orders, :link, :cat_id, now())");
                                        $stmt->execute(array(
                                            'orders' 	 => $ordering,
                                            'link' 	 => $description,
                                            'cat_id' => $parent
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="table-responsive ">
                                        <table class="table ">
                                            ...
                                            <tbody>
                                            <?php
                                                $stmt = $con->prepare("SELECT *, category.category_name as category_name FROM live inner join category on category.category_id = live.cat_id");
                                                $stmt->execute(array());
                                                $lives = $stmt->fetchAll();
                                                if (! empty($lives)) {
