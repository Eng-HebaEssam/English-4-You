                            ...
                            if (isset($_POST['add'])) {
                                ...
                                if (empty($formErrors)) {
                                        $stmt = $con->prepare("INSERT INTO 
                                            events(orders, events_name, events_description,events_date,events_time, cat_id)
                                        VALUES(:orders, :vname, :vdesc,:vdate,:vtime, :cat_id)");
                                        $stmt->execute(array(
                                            'orders' 	=> $ordering,
                                            'vname' 	=> $name,
                                            'vdesc' 	=> $description,
                                        ...
                                        <table class="table" id="datatableid">
                                            ...
                                            foreach($rows as $row) {?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button " class="btn btn-outline-success btn-sm edit_event main_view" value="<?php echo $row['events_id'];?>" data-toggle="modal" data-target="#edit">تعديل</button>
