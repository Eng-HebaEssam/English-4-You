...
<div class="form-group ">
    <h4>وصف الدرس</h4>
    <textarea name="description" class="form-control text-left" style="height: 150px;" dir="rtl"><?php echo $lesson['lesson_description']; ?></textarea>
</div>
<?php if ($lesson['video']) {?>
<div class="form-group ">
    <h4>الفيديو</h4>
    <textarea name="video" class="form-control text-left" style="height: 150px;" required dir="ltr"><?php echo $lesson['video']; ?></textarea>
</div>
<?php } if ($lesson['youtube'] == 0) {?>
<div class="form-group ">
    <h4>ورق الشرح</h4>
    <textarea name="pdf" class="form-control"  style="height: 100px;" ><?php echo $lesson['pdf']; ?></textarea>
</div>
<div class="form-group ">
    <h4>  اظهار الدرس :</h4>
