        ...
        <div class="main-panel ">
                <div class="content-wrapper ">
                  ...
                  <i class="mdi mdi-home "></i>
                         ...
                         <button style="margin-right:120px; color:darkblue; font-size:15px" type="button " class="btn btn-outline-info btn-sm"data-toggle="modal" data-target="#add">أضافة مقال</button>
                    </div>
                    <?php       
                                ...
                                if (empty($formErrors)) {
                                    ...
                                    $uploads_dir = 'uploads';
                                        ...
                                        $stmt = $con->prepare("INSERT INTO 
                                            post(orders, post_name, post_description,post_data,users,type,post_image)
                                        VALUES(:orders,:pname, :pdesc,now(),:puser,1,:pimage)");
                                        $stmt->execute(array(
                                            'orders' 	=> $ordering,
                                            'pname' 	=> $name,
                                            'pdesc' 	=> $description,
                                    ...
                                    <div class="table-responsive ">
							            ...
							            foreach($rows as $row) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button " class="btn btn-outline-success btn-sm edit_post main_view" value="<?php echo $row['post_id'];?>" data-toggle="modal" data-target="#edit">تعديل</button>
